...
from sw_checkin.checkin import RESPONSE_STATUS_INVALID, RESPONSE_STATUS_RES_NOT_FOUND, RESPONSE_STATUS_SUCCESS, \
...
class ReservationForm(forms.Form):
    ...
    def clean(self):
        ...
        if first_name and last_name and conf_num:
            response_code, content = checkin.attempt_checkin(conf_num, first_name, last_name)
